...
import general.pages.welcome.pages.WelcomePage;
...
public class ActionWelcomePage extends WelcomePage {

    public ActionWelcomePage(WebDriver driver) {
        super(driver);
    ...
    public ActionSingPage openSignWindow(){
        loginBtn.click();
        waitingElement(singWindow);
        return new ActionSingPage(driver);
    }
